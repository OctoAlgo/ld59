    ...
    public static List <string> planetNames = new List<string>
{
    ...
    public static List<QuestionAnswerPair> GetAlienTypeQuestions(Alien.AlienType type)
    {
        switch (type)
        {
            case MixedSignals.Alien.AlienType.NERD: return nerdQuestions;
    ...
    public static string GetRandomDislike()
    {
        return alienLikes[Random.Range(0, alienLikes.Count)];
    }

    public static string GetRandomLike()
    {
        return alienLikes[Random.Range(0, alienLikes.Count)];
    }
    ...
    public static QuestionAnswerPair GetRandomQuestion()
    {
        return normal[Random.Range(0, normal.Count)];
    }

    public static string GetRandomSolarSystem()
    {
